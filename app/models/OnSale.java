 ...
 */
@Entity
public class OnSale extends BaseModel{
    private static final long serialVersionUID = 1L;
    public static final boolean ACTIVE = true;
    public static final boolean INACTIVE = false;
    private static final String LOG_TYPE = "ADMIN";
    private static final String LOG_TABLE_NAME = "on_sale";
    ...
    public static Finder<Long, OnSale> find = new Finder<Long, OnSale>(Long.class, OnSale.class);

    public static int getNextSequence(Long brandId){
        SqlQuery sqlQuery = Ebean.createSqlQuery(
                "select max(sequence) as max from on_sale where status = true and brand_id = :brandId");
    ...
    public static Page<OnSale> page(int page, int pageSize, String sortBy, String order, String name, Integer filter, Brand brand) {
        ExpressionList<OnSale> qry = OnSale.find
                .where()
    ...
    public static OnSale findByProduct(Product product, Brand brand) {
        return
                find.where()
                        .eq("is_deleted", false)
                        .eq("brand", brand)
    ...
    public String getChangeLogData(OnSale data){
    ...
    @Override
    public void update() {
        OnSale oldBanner = OnSale.find.byId(id);
        super.update();
    ...
    public void updateStatus(String newStatus) {
        ...
        if(newStatus.equals("active"))
            status = OnSale.ACTIVE;
        else if(newStatus.equals("inactive"))
            status = OnSale.INACTIVE;
    ...
    public static OnSale findById(Long id, Long brandId) {
